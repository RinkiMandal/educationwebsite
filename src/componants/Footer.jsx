...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center mt-14 bg-neutral-900 text-center text-white">
      <div className="container px-6 pt-6">
        <div className='flex justify-center mb-6 gap-6 '>
        <FaFacebook size={35} color="white"  />
          <FaTwitter size={35} color="white"  />
          <FaGooglePlus size={35} color="white"  />
          <FaInstagramSquare size={35} color="white"  />
          <FaLinkedin size={35} color="white"  />
          <FaSquareGithub size={35} color="white"  />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="mb-6">
              <h5 className="mb-2.5 font-bold uppercase">Programs</h5>
              <ul className="mb-2 list-none">
                <li>
                  <a href="#!" className="text-white">SEO Business</a>
                </li>
                <li>
                  <a href="#!" className="text-white">Digital Marketing</a>
                </li>
                <li>
                  <a href="#!" className="text-white">Graphic Design</a>
                </li>
                <li>
                  <a href="#!" className="text-white">Social Marketing</a>
                </li>
              </ul>
            </div>
